...
from .utils import mkdir, init_distributed_mode, save_on_master, collate_fn
...
def main(args):
    ...
    data_loader = torch.utils.data.DataLoader(
        dataset, batch_sampler=train_batch_sampler, num_workers=args.workers, collate_fn=collate_fn
    )
